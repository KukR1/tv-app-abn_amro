...
<template>
  <article
    class="group relative w-36 min-w-36 overflow-hidden rounded-lg transition duration-300 hover:shadow-[0_12px_40px_rgba(243,192,0,0.25)] sm:w-40 sm:min-w-40 md:w-48 md:min-w-48"
    ...
    >
      <div class="w-full space-y-2 text-xs text-neutral-200">
        <div class="flex items-center justify-between gap-2">
          ...
          <span class="inline-flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-yellow-500 text-black font-bold" aria-hidden="true"> ▶ </span>
        </div>
